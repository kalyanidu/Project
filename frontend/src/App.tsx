...
import SupportEngine from './chat_Support/SupportEngine/SupportEngine'
import SupportWindow from './chat_Support/SupportEngine/SupportWindow/SupportWindow'
...
function App() {
  ...
  }, [ref, setVisible]); // Include setVisible in the dependency array if it's used inside the effect
  ...
  return (
    ...
    >
        ...
        >
          <div className="d-flex justify-content-between align-items-center">
            <LinkContainer to="/" className="header-link">
              <Navbar.Brand>PharmaEase
              <Link to="/" className="navbar-brand">
                <img src={logo} alt="PharmaEase" style={{ height: '70px' }} /> 
              </Link>
      ...
      <main>
        <Container fluid>
          {/* it is a placeholder for routes we define in the BrowserRouter  */}
          <Outlet />
        </Container>
      </main>
      <footer>
